...
data class HealthProfile (
    ...
    @Json(name = "languages")
    val languages: kotlin.String? = null,
    @Json(name = "allergies")
    val allergies: kotlin.String? = null,
    @Json(name = "medications")
    val medications: kotlin.String? = null,
    @Json(name = "healthConditions")
    val healthConditions: kotlin.String? = null,
    @Json(name = "surgeryProcedures")
    val surgeryProcedures: kotlin.String? = null,
    ...
    val familyHistoryDiseases: kotlin.String? = null,
    @Json(name = "familyHistoryDiseaseOthers")
    val familyHistoryDiseaseOthers: kotlin.String? = null
)
