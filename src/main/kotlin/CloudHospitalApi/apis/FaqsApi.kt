...
interface FaqsApi {
    ...
    suspend fun apiV1FaqsFaqIdGet(@Path("faqId") faqId: java.util.UUID): Response<FaqViewModel>
    ...
    suspend fun apiV1FaqsSlugsSlugGet(@Path("slug") slug: kotlin.String): Response<FaqViewModel>
