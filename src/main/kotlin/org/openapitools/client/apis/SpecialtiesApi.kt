...
interface SpecialtiesApi {
    ...
    fun apiV1SpecialtiesSlugsSlugGet(@Path("slug") slug: kotlin.String, @Query("languageCode") languageCode: kotlin.String? = null): Call<SpecialtyViewModel>
    ...
    fun apiV1SpecialtiesSpecialtyIdGet(@Path("specialtyId") specialtyId: java.util.UUID, @Query("languageCode") languageCode: kotlin.String? = null): Call<SpecialtyViewModel>
