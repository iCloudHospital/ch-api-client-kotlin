...
launch(Dispatchers.IO) {
    val result : HospitalReviewsViewModel = webService.apiV1HospitalsReviewsGet(patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, lastRetrieved)
}
```
