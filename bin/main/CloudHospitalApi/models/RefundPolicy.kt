...
enum class RefundPolicy(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is RefundPolicy) "$data" else null

        /**
         * Returns a valid [RefundPolicy] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): RefundPolicy? = data?.let {
